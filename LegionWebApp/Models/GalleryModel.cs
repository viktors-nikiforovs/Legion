namespace LegionWebApp.Models
{
    ...
    public class GalleryModel
    {
        ...
        {
            CreateItem("On February 15, medicine for prisoners of war was sent to Kramatorsk.", new string[] { "1.jpeg", "2.jpeg", "3.jpeg", "4.jpeg" }, null, null, new DateOnly(2023, 02, 15));
