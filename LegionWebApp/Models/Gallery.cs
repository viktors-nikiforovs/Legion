namespace LegionWebApp.Models
{
    ...
    public class Gallery
    {
        ...
        private void CreateList()
        {
            ...
            CreateItem("On October 21, charitable assistance was transferred to Kyiv City Clinical Hospital 6.", true, new string[] { "2.jpeg", "1.jpeg" }, new int[] { 5, 5 }, new string[] { "3.mp4", "1.mp4", "2.mp4" }, new int[] { 4, 4, 4 }, null, new DateOnly(2022, 10, 21));
            ...
            CreateItem("On October 15-2, Lysohirka, Izum Region.", false, new string[] { "1.jpg" }, new int[] { 6 }, new string[] { "4.mp4", "3.mp4", "2.mp4", "1.mp4" }, new int[] { 12, 6, 6, 6 }, null, new DateOnly(2022, 10, 15), "-2");
            CreateItem("On October 15-1, Щасливе, Izum Region.", false, new string[] { "1.jpg", "2.jpg", "6.jpg", "4.jpg", "5.jpg", "3.jpg" }, new int[] { 6, 6, 6, 6, 6, 6 }, new string[] { "3.mp4", "2.mp4", "1.mp4" }, new int[] { 12, 6, 6 }, null, new DateOnly(2022, 10, 15), "-1");
