namespace LegionWebApp.Models
{
    ...
    public class Gallery
    {
        ...
        {
            CreateItem("On March 15, together with the <a href=\"https://frida-ukraine.com/\">www.FRIDA-Ukraine.com</a> Foundation delivered medicine for field hospital (medical unit) of the 72nd brigade.", new string[] { "1.jpeg", "2.jpeg", "3.jpeg", "4.jpeg", "5.jpeg", "6.jpeg", "7.jpeg", "8.jpeg", "9.jpeg", "10.jpeg", "11.jpeg" }, new string[] {"1.mp4"}, new string[] { "poster.PNG" }, new DateOnly(2023, 03, 15));
