namespace LegionWebApp.Models
{
    ...
    public class Gallery
    {
        ...
        {
            CreateItem("On February 15, medicine for prisoners of war was sent to Kramatorsk", true, new string[] { "3.jpeg", "4.jpeg", "1.jpeg", "2.jpeg" }, new int[] { 4, 4, 4, 4 }, null, null, null, new DateOnly(2023, 02, 15));
